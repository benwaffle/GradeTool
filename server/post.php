<?php
require "assets/php/twilio/Services/Twilio.php";

if (!isset($_POST)
 || !isset($_POST["notif_due"] || !isset($POST["notif_phone"])
 || !isset($_POST["notif_body"])
...
mysql_query("INSERT INTO notifications (DueDate, PhoneNumber, Body) \
	VALUES('".$notification["DueDate"]."','".$notification["PhoneNumber"]."',
	'".$notification["Body"]."')");
mysql_close($con);
